...
parser.add_argument('--noise_dir', default='/home/kiochy/kcc2022-1/TAU-urban-acoustic-scenes-2020-mobile-development/audio/', type=str)
...
parser.add_argument('--path_save_spectrogram', default='/home/kiochy/kcc2022-1/Train_all/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/home/kiochy/kcc2022-1/Train_all/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='/home/kiochy/kcc2022-1/Train_all/sound/', type=str)
...
parser.add_argument('--dir_save_prediction', default='./demo_data/save_predictions_all/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['noisy_voice_long_all.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_all.wav', type=str)
