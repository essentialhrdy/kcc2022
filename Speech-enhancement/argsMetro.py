...
parser.add_argument('--noise_dir', default='/home/kiochy/kcc2022-1/dataset/metro/', type=str)
...
parser.add_argument('--path_save_spectrogram', default='/home/kiochy/kcc2022-1/separate/Metro/train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/home/kiochy/kcc2022-1/separate/Metro/train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='/home/kiochy/kcc2022-1/separate/Metro/train/sound/', type=str)
...
parser.add_argument('--weights_folder', default='./weightsmetro', type=str)
...
parser.add_argument('--dir_save_prediction', default='./demo_data/save_predictions_metro/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['noisy_voice_long_metro.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_metro.wav', type=str)
