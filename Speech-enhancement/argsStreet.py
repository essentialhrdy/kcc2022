...
parser.add_argument('--noise_dir', default='/home/kiochy/kcc2022-1/dataset/street/', type=str)

parser.add_argument('--voice_dir', default='/home/kiochy/kcc2022-1/Train_all/clean_voice/', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='/home/kiochy/kcc2022-1/separate/Street/train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='/home/kiochy/kcc2022-1/separate/Street/train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='/home/kiochy/kcc2022-1/separate/Street/train/sound/', type=str)
#How much frame to create in data_creation mode
parser.add_argument('--nb_samples', default=15000, type=int)
...
parser.add_argument('--weights_folder', default='./weightsstreet', type=str)
...
parser.add_argument('--dir_save_prediction', default='./demo_data/save_predictions_street/', type=str)
#Noisy sound file to denoise (prediction mode)
parser.add_argument('--audio_input_prediction', default=['noisy_voice_long_street2.wav'], type=list)
#File name of sound output of denoise prediction
parser.add_argument('--audio_output_prediction', default='denoise_street2.wav', type=str)
